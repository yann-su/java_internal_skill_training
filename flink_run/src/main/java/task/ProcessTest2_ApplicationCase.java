...
public class ProcessTest2_ApplicationCase {
    ...
    public static class TempConsIncreWarning extends KeyedProcessFunction<String, SensorReading, String> {
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            obj = getRuntimeContext().getState(new ValueStateDescriptor<String>("String", String.class));
        ...
        public void processElement(SensorReading value, Context ctx, Collector<String> out) throws Exception {
            ...
            out.collect(""+obj.value());
            out.collect(""+lastTemperature.value());
            // 计时器状态值(时间戳)
